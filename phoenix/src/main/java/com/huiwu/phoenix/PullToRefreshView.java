...
import com.huiwu.phoenix.refresh_view.BaseRefreshView;
import com.huiwu.phoenix.refresh_view.CarRefreshView;
import com.huiwu.phoenix.refresh_view.SunRefreshView;
import com.huiwu.phoenix.util.Utils;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public static final int STYLE_CAR = 1;
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.PullToRefreshView_type, STYLE_CAR);
        a.recycle();
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                ...
                break;
            case STYLE_CAR:
                mBaseRefreshView = new CarRefreshView(getContext(), this);
                break;
            default:
